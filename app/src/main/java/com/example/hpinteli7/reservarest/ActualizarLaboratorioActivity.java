...
@SuppressLint("NewApi")
public class ActualizarLaboratorioActivity extends AppCompatActivity {
    ...
    private final String urlHostingGratuito = "http://cm12036pdm115.000webhostapp.com/ws_laboratorio_update.php";

    @SuppressLint("NewApi")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_actualizar_laboratorio);
    ...
    public void ActualizarLab(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_cicloExterno:
                ...
                ControladorServicio.actualizarLaboratorioExterno(url, this);
                break;
        }
